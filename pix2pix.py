# imports to handle python versions
from __future__ import absolute_import
from __future__ import division
from __future__ import print_function

# imports to get package dependencies
...
# arguments for the training and testing hyper-parameters
...
# arguments for the options pertaining to the input fot hte models
...
# arguments for the options pertaining to the loss function hyper-parameters
parser.add_argument("--lr", type=float, default=0.0002, help="initial learning rate for adam")
parser.add_argument("--beta1", type=float, default=0.5, help="momentum term of adam")
parser.add_argument("--l1_weight", type=float, default=100.0, help="weight on L1 term for generator gradient")
parser.add_argument("--gan_weight", type=float, default=1.0, help="weight on GAN term for generator gradient")

# arguments for the export options
...
# elements of the networks' definition
########################################################################################################################
# Covolution element
...
# converison of RGB channels to Lab color spectrum
...
# converison of Lab color spectrum to RGB channels
def lab_to_rgb(lab):
...
########################################################################################################################
# loading examples to check environment
def load_examples():
    ...
    # if the image names are numbers, sort by the value rather than lexicographically
...
# creating generator models with specified configuration
...
# creating the descriminator and the bridge with the generator model with specified configuration
...
# saving the images from the output
